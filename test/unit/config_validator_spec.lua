describe('config_validator', function()
  ...
  describe('check_unknown_fields()', function()
    ...
    it('should warn about unknown fields', function()
      ...
      -- Check that both warnings exist (order is not guaranteed in Lua tables)
      local all_warnings = table.concat(warnings, '\n')
      assert.match('unknown_field.*unknown field', all_warnings)
      assert.match('another_typo.*unknown field', all_warnings)
    end)
